...
class SBERT_zscore_absmin(BaseFeatureExtraction):
    ...
    name = "sbert_zscore_absmin"
    label = "SBert zscore_absmin"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_zscore_absmin, self).__init__(*args, **kwargs)
