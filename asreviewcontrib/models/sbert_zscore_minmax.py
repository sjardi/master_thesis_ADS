...
class SBERT_zscore_minmax(BaseFeatureExtraction):
    ...
    name = "sbert_zscore_minmax"
    label = "SBert zscore_minmax"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_zscore_minmax, self).__init__(*args, **kwargs)
