...
__all__ = ["Doc2Vec_pareto_sigmoid"]
...
class Doc2Vec_pareto_sigmoid(BaseFeatureExtraction):
    ...
    name = "doc2vec_pareto_sigmoid"
    label = "Doc2Vec_pareto_sigmoid"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_pareto_sigmoid, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_pareto_sigmoid, self).full_hyper_space()
        hyper_space.update(
            {
