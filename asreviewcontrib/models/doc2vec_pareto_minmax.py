...
class Doc2Vec_pareto_minmax(BaseFeatureExtraction):
    ...
    name = "doc2vec_pareto_minmax"
    label = "Doc2Vec_pareto_minmax"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_pareto_minmax, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_pareto_minmax, self).full_hyper_space()
        hyper_space.update(
            {
