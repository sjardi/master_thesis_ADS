...
class Doc2Vec_zscore_absmin(BaseFeatureExtraction):
    ...
    name = "doc2vec_zscore_absmin"
    label = "Doc2Vec_zscore_absmin"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_zscore_absmin, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_zscore_absmin, self).full_hyper_space()
        hyper_space.update(
            {
