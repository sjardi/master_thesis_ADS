...
class Doc2VecAddAbsMin(BaseFeatureExtraction):
    ...
    name = "doc2vecaddabsmin"
    label = "Doc2VecAddAbsMin"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2VecAddAbsMin, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2VecAddAbsMin, self).full_hyper_space()
        hyper_space.update(
            {
