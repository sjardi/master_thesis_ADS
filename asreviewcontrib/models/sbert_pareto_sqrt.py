...
class SBERT_pareto_sqrt(BaseFeatureExtraction):
    ...
    name = "sbert_pareto_sqrt"
    label = "SBert pareto_sqrt"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_pareto_sqrt, self).__init__(*args, **kwargs)
