...
class SBERT_pareto_sigmoid(BaseFeatureExtraction):
    ...
    name = "sbert_pareto_sigmoid"
    label = "SBert pareto_sigmoid"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_pareto_sigmoid, self).__init__(*args, **kwargs)
