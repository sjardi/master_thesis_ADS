...
__all__ = ["SBERT_l2_normalize_absmin"]
...
class SBERT_l2_normalize_absmin(BaseFeatureExtraction):
    ...
    name = "sbert_l2_normalize_absmin"
    label = "SBert l2_normalize_absmin"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_l2_normalize_absmin, self).__init__(*args, **kwargs)
