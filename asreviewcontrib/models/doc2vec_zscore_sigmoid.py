...
__all__ = ["Doc2Vec_zscore_sigmoid"]
...
class Doc2Vec_zscore_sigmoid(BaseFeatureExtraction):
    ...
    name = "doc2vec_zscore_sigmoid"
    label = "Doc2Vec_zscore_sigmoid"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_zscore_sigmoid, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_zscore_sigmoid, self).full_hyper_space()
        hyper_space.update(
            {
