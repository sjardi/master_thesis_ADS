...
class SBERT_zscore_sigmoid(BaseFeatureExtraction):
    ...
    name = "sbert_zscore_sigmoid"
    label = "SBert zscore_sigmoid"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_zscore_sigmoid, self).__init__(*args, **kwargs)
