...
__all__ = ["SBERT_l2_normalize_sqrt"]
...
class SBERT_l2_normalize_sqrt(BaseFeatureExtraction):
    ...
    name = "sbert_l2_normalize_sqrt"
    label = "SBert l2_normalize_sqrt"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_l2_normalize_sqrt, self).__init__(*args, **kwargs)
