...
:: Classifier = nb, Feature extractor = doc2vec_sqrt, Query strategy = max, Balance strategy = double
python -m asreview simulate data\van_de_Schoot_2018.csv -s output\simulation\van_de_Schoot_2018\state_files\sim_van_de_Schoot_2018_nb_doc2vec_sqrt_max_double.asreview --model nb --query_strategy max --feature_extraction doc2vec_sqrt --init_seed 535 --seed 165 -q max -b double --n_instances 1 --stop_if min
python -m asreview metrics output\simulation\van_de_Schoot_2018\state_files\sim_van_de_Schoot_2018_nb_doc2vec_sqrt_max_double.asreview -o output\simulation\van_de_Schoot_2018\metrics\metrics_sim_van_de_Schoot_2018_nb_doc2vec_sqrt_max_double.json
