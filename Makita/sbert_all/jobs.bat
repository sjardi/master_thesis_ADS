...
:: Classifier = logistic, Feature extractor = sbert_pareto_cdf, Query strategy = max, Balance strategy = double
python -m asreview simulate data\van_de_Schoot_2018.csv -s output\simulation\van_de_Schoot_2018\state_files\sim_van_de_Schoot_2018_logistic_sbert_pareto_cdf_max_double.asreview --model logistic --query_strategy max --feature_extraction sbert_pareto_cdf --init_seed 535 --seed 165 -q max -b double --n_instances 1 --stop_if min
python -m asreview metrics output\simulation\van_de_Schoot_2018\state_files\sim_van_de_Schoot_2018_logistic_sbert_pareto_cdf_max_double.asreview -o output\simulation\van_de_Schoot_2018\metrics\metrics_sim_van_de_Schoot_2018_logistic_sbert_pareto_cdf_max_double.json
