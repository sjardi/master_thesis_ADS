...
set "feature_extractors=sbert_zscore_minmax sbert_pareto_minmax sbert_l2_normalize_minmax sbert_zscore_absmin sbert_pareto_absmin sbert_l2_normalize_absmin sbert_zscore_sqrt sbert_pareto_sqrt sbert_l2_normalize_sqrt sbert_zscore_cdf sbert_pareto_cdf sbert_l2_normalize_cdf sbert_zscore_sigmoid sbert_pareto_sigmoid sbert_l2_normalize_sigmoid sbertminmax sbertabsmin sbertsigmoid sbert_cdf sbert sbert_sqrt"
