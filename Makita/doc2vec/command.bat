...
asreview makita template multimodel --classifiers logistic nb --feature_extractors doc2vec doc2vecminmax doc2vecaddabsmin doc2veccdf doc2vecsigmoid

::asreview makita template multimodel --classifiers logistic nb --feature_extractors doc2vec doc2vecaddabsmin doc2vecminmax tfidfrelu tfidfn tfidfminmax tfidflognorm tfidfaddabsmin
