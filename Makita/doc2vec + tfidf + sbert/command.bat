...
asreview makita template multimodel --classifiers logistic nb --feature_extractors doc2vec doc2vecaddabsmin doc2vecminmax doc2vecsoftplus tfidfrelu tfidfn tfidfminmax tfidflognorm tfidfaddabsmin sbertminmax sbertabsmin
