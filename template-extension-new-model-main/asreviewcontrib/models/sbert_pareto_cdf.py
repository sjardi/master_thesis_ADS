...
class SBERT_pareto_cdf(BaseFeatureExtraction):
    ...
    name = "sbert_pareto_cdf"
    label = "SBert pareto_cdf"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_pareto_cdf, self).__init__(*args, **kwargs)
