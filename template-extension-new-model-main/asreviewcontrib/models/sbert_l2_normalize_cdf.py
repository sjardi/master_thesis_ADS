...
__all__ = ["SBERT_l2_normalize_cdf"]
...
class SBERT_l2_normalize_cdf(BaseFeatureExtraction):
    ...
    name = "sbert_l2_normalize_cdf"
    label = "SBert l2_normalize_cdf"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_l2_normalize_cdf, self).__init__(*args, **kwargs)
