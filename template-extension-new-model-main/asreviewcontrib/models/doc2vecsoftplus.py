...
class Doc2VecSoftplus(BaseFeatureExtraction):
    ...
    name = "doc2vecsoftplus"
    label = "Doc2VecSoftplus"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2VecSoftplus, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(
            Doc2VecSoftplus, self).full_hyper_space()
        hyper_space.update(
            {
