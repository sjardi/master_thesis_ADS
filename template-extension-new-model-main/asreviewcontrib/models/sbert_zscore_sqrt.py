...
class SBERT_zscore_sqrt(BaseFeatureExtraction):
    ...
    name = "sbert_zscore_sqrt"
    label = "SBert zscore_sqrt"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_zscore_sqrt, self).__init__(*args, **kwargs)
