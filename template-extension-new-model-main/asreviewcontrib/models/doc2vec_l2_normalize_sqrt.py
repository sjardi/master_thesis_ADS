...
__all__ = ["Doc2Vec_l2_normalize_sqrt"]
...
class Doc2Vec_l2_normalize_sqrt(BaseFeatureExtraction):
    ...
    name = "doc2vec_l2_normalize_sqrt"
    label = "Doc2Vec_l2_normalize_sqrt"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_l2_normalize_sqrt, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_l2_normalize_sqrt, self).full_hyper_space()
        hyper_space.update(
            {
