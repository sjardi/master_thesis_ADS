...
class Doc2Vec_sqrt(BaseFeatureExtraction):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_sqrt, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_sqrt, self).full_hyper_space()
        hyper_space.update(
            {
