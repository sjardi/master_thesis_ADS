...
class SBERT_zscore_cdf(BaseFeatureExtraction):
    ...
    name = "sbert_zscore_cdf"
    label = "SBert zscore_cdf"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_zscore_cdf, self).__init__(*args, **kwargs)
