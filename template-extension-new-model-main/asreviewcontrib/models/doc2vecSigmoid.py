...
class Doc2VecSigmoid(BaseFeatureExtraction):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2VecSigmoid, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2VecSigmoid, self).full_hyper_space()
        hyper_space.update(
            {
