...
class SBERT_pareto_minmax(BaseFeatureExtraction):
    ...
    name = "sbert_pareto_minmax"
    label = "SBert pareto_minmax"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_pareto_minmax, self).__init__(*args, **kwargs)
