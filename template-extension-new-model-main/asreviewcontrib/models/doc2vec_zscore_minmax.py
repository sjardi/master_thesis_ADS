...
class Doc2Vec_zscore_minmax(BaseFeatureExtraction):
    ...
    name = "doc2vec_zscore_minmax"
    label = "Doc2Vec_zscore_minmax"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_zscore_minmax, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_zscore_minmax, self).full_hyper_space()
        hyper_space.update(
            {
