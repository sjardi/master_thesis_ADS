...
__all__ = ["Doc2Vec_l2_normalize_minmax"]
...
class Doc2Vec_l2_normalize_minmax(BaseFeatureExtraction):
    ...
    name = "doc2vec_l2_normalize_minmax"
    label = "Doc2Vec_l2_normalize_minmax"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_l2_normalize_minmax, self).__init__(*args, **kwargs)
        ...
        self.name = "Doc2Vec_l2_normalize_minmax"
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_l2_normalize_minmax, self).full_hyper_space()
        hyper_space.update(
            {
