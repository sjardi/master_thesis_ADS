...
__all__ = ["Doc2Vec_l2_normalize_absmin"]
...
class Doc2Vec_l2_normalize_absmin(BaseFeatureExtraction):
    ...
    name = "doc2vec_l2_normalize_absmin"
    label = "Doc2Vec_l2_normalize_absmin"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_l2_normalize_absmin, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_l2_normalize_absmin, self).full_hyper_space()
        hyper_space.update(
            {
