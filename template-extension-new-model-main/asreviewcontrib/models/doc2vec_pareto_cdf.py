...
class Doc2Vec_pareto_cdf(BaseFeatureExtraction):
    ...
    name = "doc2vec_pareto_cdf"
    label = "Doc2Vec_pareto_cdf"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Doc2Vec_pareto_cdf, self).__init__(*args, **kwargs)
    ...
    def full_hyper_space(self):
        ...
        hyper_space, hyper_choices = super(Doc2Vec_pareto_cdf, self).full_hyper_space()
        hyper_space.update(
            {
