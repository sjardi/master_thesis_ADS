...
class SBERT_pareto_absmin(BaseFeatureExtraction):
    ...
    name = "sbert_pareto_absmin"
    label = "SBert pareto_absmin"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_pareto_absmin, self).__init__(*args, **kwargs)
