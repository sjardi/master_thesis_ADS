...
__all__ = ["SBERT_l2_normalize_sigmoid"]
...
class SBERT_l2_normalize_sigmoid(BaseFeatureExtraction):
    ...
    name = "sbert_l2_normalize_sigmoid"
    label = "SBert l2_normalize_sigmoid"
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBERT_l2_normalize_sigmoid, self).__init__(*args, **kwargs)
